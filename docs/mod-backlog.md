...
| --- | --- | --- | --- | --- |
| [Blood Trails](https://www.nexusmods.com/witcher3/mods/8065) | z5tjm8, Scoutbr0, Immersion | Strong fit for tracking, hunting, and difficult immersive play if it adds behavior beyond current W3EE/RER blood systems. | Not downloaded. Lower priority after audit: W3EE already has BloodTrail options/effects and RER has corpse/blood trail logic. Inspect archive before installing. See `logs/assess-next-backlog-candidates-2026-06-28.md`. | Backlog - lower priority |
...
| [Roach Gwent Card for Everyone](https://www.nexusmods.com/witcher3/mods/10898) | z5tjm8, paulr0013, Gwent | Small unlock/QoL candidate. | Not downloaded. Still promising, but must inspect against `modGwentRedux` and `modPatchGwentRedux_W3EE_W3EERedux` before install. | Backlog - download needed |
...
| [Richer Merchants](https://www.nexusmods.com/witcher3/mods/8212) | z5tjm8, shiv4444, Tweaks | Supports the surface goal of less broke merchants, but it is the wrong lever for this stack. | Not downloaded. Defer: active FOCES/W3EE already owns merchant funds/restock. Tune existing economy values instead of stacking raw merchant-money changes. | Deferred |
| [Well Stocked Craftsmen](https://www.nexusmods.com/witcher3/mods/3002) | z5tjm8, Partoutatix, Tweaks | Could support long-term grandmaster crafting goals without directly increasing money. | Not downloaded. More interesting than Richer Merchants if it is vendor stock/content data; defer if it ships broad shop/crafting scripts. | Backlog - download needed |
...
| [Vampires Have No Shadows](https://www.nexusmods.com/witcher3/mods/1749) | z5tjm8, djkovrik, Immersion | Strong lore/immersion idea. | Not downloaded. Best remaining narrow visual/lore candidate from this group; inspect exact paths after download to ensure it does not fight RT/HDRP globally. | Backlog - download needed |
