...
| --- | --- | --- | --- | --- |
| [Blood Trails](https://www.nexusmods.com/witcher3/search/?gsearch=Blood%20Trails&gsearchtype=mods) | z5tjm8, Scoutbr0, Immersion | Strong fit for tracking, hunting, and difficult immersive play. | Check overlap with W3EE blood/combat effects before install. | Backlog |
| [Viper Venomous Silver Sword Schematic Restored - Next Gen](https://www.nexusmods.com/witcher3/search/?gsearch=Viper%20Venomous%20Silver%20Sword%20Schematic%20Restored&gsearchtype=mods) | z5tjm8, konyme, Alchemy and Crafting | Small restoration candidate; likely better value/risk than broad crafting mods. | Verify against W3EE item/progression changes. | Backlog |
| [Roach Gwent Card for Everyone](https://www.nexusmods.com/witcher3/search/?gsearch=Roach%20Gwent%20Card%20for%20Everyone&gsearchtype=mods) | z5tjm8, paulr0013, Gwent | Small unlock/QoL candidate. | Check against Gwent Redux before install. | Backlog |
| [Additional Armor Stands](https://www.nexusmods.com/witcher3/search/?gsearch=Additional%20Armor%20Stands&gsearchtype=mods) | z5tjm8, djkovrik, Immersion | Good fit if we want Corvo Bianco/display-room enrichment. | Verify overlap with Corvo Bianco Guests/Enhanced and container/world edits. | Backlog |
| [Extra Stashes](https://www.nexusmods.com/witcher3/search/?gsearch=Extra%20Stashes&gsearchtype=mods) | z5tjm8, MerseyRockoff, Immersion | Useful QoL if storage friction becomes annoying. | Could reduce scarcity/weight pressure; check world/container conflicts. | Backlog |
| [Richer Merchants](https://www.nexusmods.com/witcher3/search/?gsearch=Richer%20Merchants&gsearchtype=mods) | z5tjm8, shiv4444, Tweaks | Supports goal of being rewarded for selling to proper buyers. | Likely overlaps Floren economy/reputation and W3EE economy. Review values first. | Backlog |
| [Well Stocked Craftsmen](https://www.nexusmods.com/witcher3/search/?gsearch=Well%20Stocked%20Craftsmen&gsearchtype=mods) | z5tjm8, Partoutatix, Tweaks | Could support long-term grandmaster crafting goals. | Economy/crafting overlap. Needs deliberate balance review. | Backlog |
| [Characters Hi-Res Shadows - Next Gen](https://www.nexusmods.com/witcher3/search/?gsearch=Characters%20Hi-Res%20Shadows%20Next%20Gen&gsearchtype=mods) | z5tjm8, TheRealArdCarraigh, Visuals and Graphics | Potential visual upgrade. | Check RTX/HDRP overlap and performance. | Backlog |
| [Vampires Have No Shadows](https://www.nexusmods.com/witcher3/search/?gsearch=Vampires%20Have%20No%20Shadows&gsearchtype=mods) | z5tjm8, djkovrik, Immersion | Strong lore/immersion idea. | Check if it touches broad entity/material bundles. | Backlog |
| [Professional Witcher Belt and Items](https://www.nexusmods.com/witcher3/search/?gsearch=Professional%20Witcher%20Belt%20and%20Items&gsearchtype=mods) | z5tjm8, Bjorn18, Immersion | Visual immersion candidate if it does not fight AMM/equipment visuals. | Appearance stack is already dense. Inspect file paths first. | Backlog |
...
| Economy/crafting bundles: Better Gold, Rational Crafting, Tweaks Collection | z5tjm8 | Broad balance overlap with W3EE Redux, Floren economy, reputation, and crafting goals. Inspect before install. |
