...
| --- | --- | --- | --- | --- |
| [Blood Trails](https://www.nexusmods.com/witcher3/mods/8065) | z5tjm8, Scoutbr0, Immersion | Strong fit for tracking, hunting, and difficult immersive play if it adds behavior beyond current W3EE/RER blood systems. | Avoided by user decision on 2026-06-28. W3EE already has BloodTrail options/effects and RER has corpse/blood trail logic, so this is not worth stacking unless a specific tracking bug appears. See `logs/assess-next-backlog-candidates-2026-06-28.md`. | Avoided |
| [Viper Venomous Silver Sword Schematic Restored - Next Gen](https://www.nexusmods.com/witcher3/mods/7442) | z5tjm8, konyme, Alchemy and Crafting | Small restoration candidate; likely better value/risk than broad crafting mods. | Installed as `modVVSSDiagramRestoredVerCNextGen` at priority `265`; content-only and DX12 smoke passed. | Installed |
| [Roach Gwent Card for Everyone](https://www.nexusmods.com/witcher3/mods/10898) | z5tjm8, paulr0013, Gwent | Small unlock/QoL candidate. | Avoided by user decision on 2026-06-28. Current Gwent stack is already substantial, and this is not needed for the target experience. | Avoided |
...
| [Richer Merchants](https://www.nexusmods.com/witcher3/mods/8212) | z5tjm8, shiv4444, Tweaks | Supports the surface goal of less broke merchants, but it is the wrong lever for this stack. | Avoided by user decision on 2026-06-28. Active FOCES/W3EE already owns merchant funds/restock; tune existing economy values instead of stacking raw merchant-money changes. | Avoided |
| [Well Stocked Craftsmen](https://www.nexusmods.com/witcher3/mods/3002) | z5tjm8, Partoutatix, Tweaks | Could support long-term grandmaster crafting goals without directly increasing money. | Avoided by user decision on 2026-06-28. Revisit only if late-game grandmaster crafting is blocked by vendor stock after normal W3EE/economy tuning. | Avoided |
| [Characters Hi-Res Shadows - Next Gen](https://www.nexusmods.com/witcher3/mods/10591) | z5tjm8, TheRealArdCarraigh, Visuals and Graphics | Potential visual upgrade. | Not downloaded. Move to graphics/performance pass only; current stack already has HDRP, RTCHAR DX12, RTCHAR eyes, and dense lighting/weather layers. | Backlog - graphics pass |
| [Vampires Have No Shadows](https://www.nexusmods.com/witcher3/mods/1749) | z5tjm8, djkovrik, Immersion | Strong lore/immersion idea. | Installed as `modVampiresHaveNoShadows` at priority `268`. The full shipped `npc.ws` is intentionally not allowed to win; only its helper is active plus a small manual graft into `mod0000_MergedFiles`. See `logs/install-vampires-have-no-shadows-1749-2026-06-28.md`. | Installed - manual graft |
| [Professional Witcher Belt and Items](https://www.nexusmods.com/witcher3/mods/5911) | z5tjm8, Bjorn18, Immersion | Visual immersion candidate if there is a specific belt/item appearance goal. | Not downloaded. Low priority because AMM, Swords on Roach, Hoods, and the body/appearance stack already own this visual lane. | Backlog - low priority |
